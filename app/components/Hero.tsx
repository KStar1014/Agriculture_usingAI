          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-4 pt-8">
              <div className="flex -space-x-2">
                ...
                <div className="w-10 h-10 rounded-full bg-[url('/images/men_1.jpg')] bg-cover bg-center opacity-90 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"></div>
                <div className="w-10 h-10 rounded-full bg-[url('/images/women_2.jpg')] bg-cover bg-center opacity-90 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"></div>
                <div className="w-10 h-10 rounded-full bg-[url('/images/men_2.jpg')] bg-cover bg-center opacity-90 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"></div>
                <div className="w-10 h-10 rounded-full bg-[url('/images/women_1.jpg')] bg-cover bg-center opacity-90 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"></div>
                <div className="w-10 h-10 rounded-full bg-[url('/images/women_2.jpg')] bg-cover bg-center opacity-90 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"></div>
                <div className="w-10 h-10 rounded-full bg-green-600 border-2 border-white flex items-center justify-center z-10">
