    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16">
          ...
          <div className="lg:col-span-2 bg-gradient-to-br from-green-700 to-green-900 text-white rounded-lg p-8 flex flex-col justify-center items-center relative overflow-hidden">
          ...
          <div className="flex flex-col gap-6">
            {/* Bestsellers Card */}
            <div className="bg-gray-100 rounded-lg p-6 flex flex-col justify-between items-start relative overflow-hidden h-48">
              <Image 
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8">Top sale products</h2>
        <Carousel
          opts={{
            align: "start",
          }}
